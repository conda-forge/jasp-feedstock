...
Once the `conda-forge` channel has been enabled, `jasp` can be installed with:

```
conda install jasp
```

It is possible to list all of the versions of `jasp` available on your platform with:
